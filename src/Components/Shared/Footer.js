      ...
      <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full text-white">
            ...
            <div class="p-2 border sm:flex sm:items-center ">
              ...
              <button class="w-full h-12 px-6 py-3 mt-1 text-sm font-bold tracking-wide uppercase bg-primary sm:ml-4 sm:flex-shrink-0 sm:w-auto sm:mt-0" type="submit">
                Sign Up
              </button>
            </div>
          </form>
        ...
        <div class="pt-6 border-t col-span-2 sm:col-span-1 border-white/10">
          <p class="font-bold text-white"> Services </p>

          <nav class="flex flex-col mt-6 text-sm text-black space-y-4">
        ...
        <div class="flex text-gray-500 col-span-2 space-x-4 lg:col-span-5">
